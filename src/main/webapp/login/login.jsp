...
<table border="1" ; width="320px" align="center" style=" border-collapse:collapse; border:none;">
      ...
      <td class="a_td2" ><input type="text" placeholder="输入会员名/邮箱"  name="username"/></td></tr>
      <tr style="100px"><td style="border:none">&nbsp;</td></tr>
      <tr><td class="a_td1" ><img src="a6.bmp" class="a_img1"/></td>
      <td class="a_td2" valign="middle"><input type="password" placeholder="输入密码"  name="upwd"/>&nbsp;&nbsp;<img src="a7.bmp"/></td></tr>
      <tr style="100px"><td style="border:none">&nbsp;</td></tr>
      <tr class="a_tr1" style="text-align:center">
      <td class="a_td5" class="a_td5" width="100px" height="40px" colspan="2">
      <input type="submit" value="登录"  
      style="background-color: #f52b00; width:320px; height:40px; color: white;"/></td></tr>
      
      <tr><td class="a_td5" style=" height:50px; border:none">&nbsp;</td></tr>
      <tr><td class="a_td5" align="right" colspan="2" ><font size="-1" color="#999999"><a class="a2" href="">忘记密码</a><a class="a2" href="../register/reg1.jsp">&nbsp;免费注册</a></font></td></tr>
</table>
</form>
</div>
